...
class NPYDataLoader:
    def __init__(self, batch_size, num_workers=8, folder_A =None, folder_B = None,only_test=True):
        ...
        if only_test == False:
            ...
            self.test_loader  = DataLoader(CombinedDataset(self.dataset_A, self.dataset_B), batch_size=325, shuffle=False, num_workers=16)
