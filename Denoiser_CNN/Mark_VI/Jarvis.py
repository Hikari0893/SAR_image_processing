...
class my_Unet(nn.Module):
    def __init__(self, width = 256, hight = 256):
        ...
        self.dec_conv1 = nn.ConvTranspose2d(512, 256, 3, stride=2, padding=1, output_padding=1) # (Batch_size, 256, 16, 16)
        ...
        self.dec_conv5  = nn.UpsamplingBilinear2d(scale_factor=2) # (Batch_size, 64, 256, 256)
    ...
    def forward (self, input):
        ...
        decoder_5 = self.activation_funct(self.dec_conv5(decoder_5), function) #(64,256,256)
